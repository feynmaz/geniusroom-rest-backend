...
ALLOWED_HOSTS = [
    'geniusroom_rest_backend.herokuapp.com',
...
ROOT_URLCONF = 'geniusroom_rest_backend.urls'
...
WSGI_APPLICATION = 'geniusroom_rest_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'options': '-c search_path=geniusroom-rest-main'
        },
